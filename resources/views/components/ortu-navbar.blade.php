<header class="w-full sticky top-0 z-40 shadow-sm bg-white dark:bg-gray-900/90 backdrop-blur-sm">
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <a href="{{ route('ortu.dashboard') }}" class="flex items-center gap-3">
                ...
                <div class="leading-tight">
                    <div class="text-sm font-extrabold text-emerald-700 dark:text-white">SDIT Citra Islamic School</div>
            ...
            <div class="flex items-center gap-2">
                <!-- Dark Mode Toggle -->
                <button @click="toggle()" class="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700">
                ...
                <div class="relative" x-data="{ open:false }">
                    <button @click="open=!open" class="flex items-center gap-2 p-1 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700">
                    ...
                    <div x-show="open" @click.outside="open=false" x-cloak class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-xl shadow-lg py-2 z-50">
                        <a href="{{ route('ortu.profil.edit') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">Edit Profil</a>
