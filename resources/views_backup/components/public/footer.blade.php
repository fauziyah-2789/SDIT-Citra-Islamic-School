<footer class="bg-gradient-to-r from-emerald-700 to-sky-700 text-white py-16 mt-20">
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 border-b border-sky-500/50 pb-10">
        ...
        <div>
            <div class="flex items-center gap-2 mb-3">
                <img src="{{ asset('images/logo.png') }}" class="h-8" alt="Logo SDIT">
        ...
        <div>
            ...
            <ul class="space-y-3 text-base">
                <li><a href="{{ route('public.profil.index') }}" class="hover:text-amber-300 transition">Profil Sekolah</a></li>
                <li><a href="{{ route('public.ekstrakurikuler.index') }}" class="hover:text-amber-300 transition">Ekstrakurikuler</a></li>
                <li><a href="{{ route('public.prestasi.index') }}" class="hover:text-amber-300 transition">Prestasi</a></li>
                <li><a href="{{ route('public.guru.index') }}" class="hover:text-amber-300 transition">Tenaga Pendidik</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-3 text-base">
                <li><a href="{{ route('public.berita.index') }}" class="hover:text-amber-300 transition">Berita Terbaru</a></li>
                <li><a href="{{ route('public.galeri.index') }}" class="hover:text-amber-300 transition">Galeri Kegiatan</a></li>
                <li><a href="{{ route('public.pengumuman.index') }}" class="hover:text-amber-300 transition">Pengumuman</a></li>
                <li><a href="{{ route('pendaftaran') }}" class="hover:text-amber-300 transition">PPDB Online</a></li>
            </ul>
        </div>

        {{-- KOLOM 4: KONTAK (DIPERBAIKI DENGAN TAUTAN KLIK) --}}
        <div>
            <h3 class="text-white font-bold text-lg mb-5 border-l-4 border-amber-300 pl-3">Kontak Kami</h3>
            <div class="space-y-3 text-base">
                {{-- LOKASI (Menggunakan link Google Maps/placeholder) --}}
    ...
    <div class="text-center text-emerald-100 text-sm mt-10 pt-4">
        &copy; {{ date('Y') }} SDIT Citra Islamic School. All Rights Reserved.
    </div>
</footer>