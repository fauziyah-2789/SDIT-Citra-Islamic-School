...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-8">
    @foreach($quickStats as $stat)
        <div class="bg-white rounded-xl p-5 shadow-lg border-l-4 border-{{ $stat['color'] }}-500 flex flex-col justify-center transition transform hover:scale-105 hover:shadow-2xl">
            <p class="text-xs font-semibold uppercase text-gray-700">{{ $stat['title'] }}</p>
...
{{-- MENU CEPAT --}}
<h3 class="text-xl font-bold mb-4 text-gray-800">Menu Utama Guru</h3>
